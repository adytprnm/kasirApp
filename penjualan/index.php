...
<!-- pencarian -->
	...
	<div class="row">
        	...
        	<button class="btn btn-dark" type="submit"><img src="../gambar/search1.svg" alt=""></button>
      </form>
			</div>
	</div>
...
<table class="table table-hover table-striped table-sm">
	<thead class="bg-dark text-white">
		<tr>
			...
			<th class="py-2 text-center rounded-end" width="145px">Aksi</th>
		</tr>
	</thead>
	<tbody>
		<?php  
		...
		<tr>
				...
				<td align="right">
					<a href="printnota.php?penid=<?= $data['penjualan_id'] ?>&kbl=<?= $kbl ?>" target="blank" class="btn btn-secondary btn-sm">Print Nota</a>
				...
				<div class="container">
					<div class="row">
						<div class="col-4 text-start py-3">
							...
							<a class="btn btn-dark" href="penjualan_simpan.php"><img src="../gambar/penjualanbaru1.svg" alt=""> Penjualan Baru</a>						
						</div>
